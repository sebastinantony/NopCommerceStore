...
<script type="text/javascript">
    ...
    function btnSearchClick() {
        final = url + 'search.aspx?searchterms=' + txtSearch;
...
<header id="header">
    ...
    <section class="hsecond">
        <div id="logo"><a href="/index.aspx">
            <img src="../image/logo.png" title="Polishop" alt="Polishop" /></a></div>

        <div id="search">
            <%--<div id="btnSearch" class="button-search" onclick="btnSearchClick()">
                
            </div>
            <input id="txtSearch" type="text" name="search" placeholder="Search" value="" />--%>
