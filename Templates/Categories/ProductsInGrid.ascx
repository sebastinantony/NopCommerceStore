...
<div id="content">
    ...
    <asp:Panel runat="server" ID="pnlSorting" CssClass="product-filter">
        <div class="sort">
            <b><%=GetLocaleResourceString("ProductSorting.SortBy")%></b>
            ...
            <ItemTemplate>
                <div>
                    <div class="left">
                        ...
                        <div class="name">
                            <asp:HyperLink ID="hlCategory" runat="server" /></div>
                    ...
                    <div class="cart">
                        <asp:HyperLink ID="hlDetails" CssClass="button" runat="server">Details</asp:HyperLink>
                    </div>
                </div>
            </ItemTemplate>
        </asp:DataList>
